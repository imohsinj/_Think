...
class LinkedInWebVC: UIViewController, UIWebViewDelegate {
    ...
    let linkedInKey = "81685acy0772pv"
    
    let linkedInSecret = "1Fof1KXeCcnUAX4R"
    ...
    */
    ...
    func startAuthorization() {
        ...
        let redirectURL = "https://com.vince.linkedin.oauth/oauth".addingPercentEncoding(withAllowedCharacters: CharacterSet.alphanumerics)!
        ...
        let task = URLSession.shared.dataTask(with: request as URLRequest, completionHandler: { data,response,error in
            ...
            if statusCode == 200 {
                ...
                do {
                    ...
                    let snapshotValue = (dataDictionary as AnyObject) as? NSDictionary

                    let accessToken = snapshotValue?["access_token"] as! String
...
//            let task: URLSessionDataTask = session.dataTaskWithRequest(request) { (data, response, error) -> Void in
            let task = URLSession.shared.dataTask(with: request as URLRequest, completionHandler: { data,response,error in
                ...
                if statusCode == 200 {
                    ...
                    do {
                        ...
                        let profileURLString = snapshotValue?["publicProfileUrl"] as! String
    ...
    func webView(_ webView: UIWebView, shouldStartLoadWith request: URLRequest, navigationType: UIWebViewNavigationType) -> Bool {
        ...
        if url.host == "com.vince.linkedin.oauth" {
